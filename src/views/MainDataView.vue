...
export default defineComponent({
  ...
  setup() {
    ...
    watchEffect (() => {
      totalData.value = [
        {title:"꼬마친구", allCount: databaseStore.getMiniData.length, count: databaseStore.getMiniCount, icon:"", color:"#d1e3ff", type:"mini"},
        {title:"탈것", allCount: databaseStore.getRideData.length, count: databaseStore.getRideCount, icon:"", color:"#d1e3ff", type:"ride"},
        {title:"악보", allCount: databaseStore.getMusicData.length, count: databaseStore.getMusicCount, icon:"", color:"#d1e3ff", type:"music"},
        {title:"감정표현", allCount: databaseStore.getEmotionData.length, count: databaseStore.getEmotionCount, icon:"", color:"#d1e3ff", type:"emotion"},
        {title:"헤어", allCount: databaseStore.getHairData.length, count: databaseStore.getHairCount, icon:"", color:"#d1e3ff", type:"hair"},
        {title:"초코보 갑주", allCount: databaseStore.getChocoboData.length, count: databaseStore.getChocoboCount, icon:"", color:"#d1e3ff", type:"chocobo"},
        {title:"패션 소품", allCount: databaseStore.getFashionData.length, count: databaseStore.getFashionCount, icon:"", color:"#d1e3ff", type:"fashion"},
        {title:"초상화", allCount: databaseStore.getPortraitData.length, count: databaseStore.getPortraitCount, icon:"", color:"#d1e3ff", type:"portrait"},
    ];
    })
